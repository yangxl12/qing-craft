...
- 保持掌心窑安静、克制、有手作感的工坊气质；不做积分排行、抽卡和强任务打断。
...
掌心窑当前已经完成“制坯 → 装饰 → 上釉 → 高温烧制 → 釉上彩绘 → 低温烤花 → 成品”的本地闭环。制坯、釉色、烧制和导出已经能建立基本工艺节奏，但装饰仍停留在技术演示层，用户很难通过装饰真正表达主题或留下个人印记。
...
| 现代工作室 | 单色泥、留白、低饱和点色 | 几何线、寿/喜符号、云、植物剪影 | 线描、印色、写款 | 与当前掌心窑视觉最贴近，个性化空间大 |
